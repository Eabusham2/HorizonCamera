...
final class PipelineTests: XCTestCase {
    ...
    func testProcessedPhotoEncodingProducesFullResolutionReadableContainer() throws {
        let renderer = try makeRenderer()
        var settings = CameraSettings(); settings.customMetadataEnabled = false
